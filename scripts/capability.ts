...
export const CAPABILITIES: Capability[] = [
  ...
  // 2026-09-06 追加実測（競合 fal.co.jp=防災GIS / giken.co.jp=エリアマーケティングGIS を起点）:
  //   避難所 22,200/指数0・液状化 9,900/指数0・海抜 6,600/指数0・防災マップ 6,600/指数1・
  //   津波ハザードマップ 2,900/指数0・標高を調べる 2,900/指数2。
  //   一方で事業側の語は薄い（人流データ 1,300/指数54・エリアマーケティング 390/指数22・
  //   配送ルート最適化 90/指数43）。個人が自宅を調べる語が主戦場という結論は変わらない。
  //   用途地域 14,800/指数1 と路線価 110,000/指数4 は需要が大きいが、
  //   用途地域データ(A29)は「非商用」でありプロダクトには使えない（2026-09-06 実測）。
  // 2026-09-05 キーワードプランナー実測: ハザードマップ 110,000/指数0・土砂災害警戒区域 9,900/指数0・
