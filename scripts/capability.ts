...
export const CAPABILITIES: Capability[] = [
  ...
  { group: 'data', key: 'hazard', label: '防災・ハザード情報の活用', noun: 'ハザードマップ・土砂災害警戒区域', terms: ['ハザードマップ', '土砂災害警戒区域', 'レッドゾーン', '浸水想定区域', '避難所マップ'], question: '物件や拠点の災害リスクを住所から確認できていない',
    rx: /(ハザードマップ|土砂災害(警戒区域)?|浸水想定|洪水浸水|レッドゾーン|イエローゾーン|急傾斜地|土石流|地すべり|避難(所|場所)|防災マップ|hazard ?map|flood (hazard|risk))/i },
